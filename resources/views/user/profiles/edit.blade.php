        ...
        <form action="{{ route('profiles.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="tempat_lahir" class="form-control"
                    value="{{ old('tempat_lahir', $userProfile->tempat_lahir) }}" required>
            </div>

            <div class="mb-3">
                <label>Tanggal Lahir</label>
                <input type="date" name="tanggal_lahir" class="form-control"
                    value="{{ old('tanggal_lahir', $userProfile->tanggal_lahir) }}" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <select name="jenis_kelamin" class="form-control">
                    <option value="Laki-laki"
                        {{ old('jenis_kelamin', $userProfile->jenis_kelamin) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki
                    </option>
                    <option value="Perempuan"
                        {{ old('jenis_kelamin', $userProfile->jenis_kelamin) == 'Perempuan' ? 'selected' : '' }}>Perempuan
                    </option>
                </select>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="no_paspor" class="form-control"
                    value="{{ old('no_paspor', $userProfile->no_paspor) }}">
            </div>

            <div class="mb-3">
                <label>Paspor Terbit</label>
                <input type="date" name="paspor_terbit" class="form-control"
                    value="{{ old('paspor_terbit', $userProfile->paspor_terbit) }}">
            </div>

            <div class="mb-3">
                <label>Paspor Kadaluarsa</label>
                <input type="date" name="paspor_kadaluarsa" class="form-control"
                    value="{{ old('paspor_kadaluarsa', $userProfile->paspor_kadaluarsa) }}">
            </div>

            <div class="mb-3">
                <label>Wilayah Terbit</label>
                <input type="text" name="wilayah_terbit" class="form-control"
                    value="{{ old('wilayah_terbit', $userProfile->wilayah_terbit) }}">
            </div>
