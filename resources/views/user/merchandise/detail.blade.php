                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-2 image-grid">
                            <div class="col-12">
                                <img src="{{ asset('uploads/' . $merchandise->images) }}" class="img-fluid w-100 img-large"
                                    alt="{{ $merchandise->name }}">
                            </div>
                            {{-- Jika ingin tambah gambar kecil lain, kamu bisa menambahkan relasi gallery --}}
                            {{-- <div class="col-4">
                                <img src="{{ asset('uploads/' . $merchandise->image) }}" class="img-fluid" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{ asset('uploads/' . $merchandise->image) }}" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h4 class="fw-bold">{{ $merchandise->name }}</h4>
                            </div>
                            <div>
