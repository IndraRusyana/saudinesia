                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                        <div class="row g-2 image-grid">
                            <div class="col-12">
                                <img src="{{ asset('uploads/' . $umroh->images) }}" class="img-fluid w-100 img-large"
                                    alt="{{ $umroh->name }}">
                            </div>
                            {{-- Jika ingin tambah gambar kecil lain, kamu bisa menambahkan relasi gallery --}}
                            {{-- <div class="col-4">
                                <img src="{{ asset('uploads/' . $umroh->image) }}" class="img-fluid" alt="">
                            </div>
                            <div class="col-4">
                                <img src="{{ asset('uploads/' . $umroh->image) }}" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="price-box mt-4">
                            <h5 class="fw-bold">IDR. {{ number_format($umroh->prices, 0, ',', '.') }}</h5>
                            <hr>
